...
alert('مرحبًا👋!\n\nيقدم هذا الموقع معلومات حول إمساكيات شهر رمضان، وأوقات الصلاة ومعلومات إضافية.\n\nيمكنك النقر على أي يوم لعرض أوقات الصلاة والمعلومات الإضافية لهذا اليوم.');
  ...
  // إضافة رسالة تحفيزية
  var motivationalMessage = "مرحبًا بك في اليوم الأول من شهر رمضان! 🌙💪 نتمنى لك يومًا مليئًا بالنجاح والبركات. استمتع بتجربة الصيام وابدأ رحلتك الروحية. لا تنسَ قيام الليل والدعاء في هذا الشهر الكريم. نسأل الله أن يتقبل منك ويجعله شهرًا مباركًا وسعيدًا. Ramadan Kareem! 🌙🌟";
